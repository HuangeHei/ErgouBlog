# Generated by Django 2.0.6 on 2018-06-07 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_create_time', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            name='Site',
        ...
        migrations.AddField(
            model_name='article',
            name='article_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.ArticleClass'),
        ),
    ]
